...
public class WebServerSimple implements WebServer {
    ...
    public WebServerSimple(int port, TemplateProcessor templateProcessor, ClientDao clientDao) {
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler
            .addServlet(new ServletHolder(new ClientsServlet(templateProcessor, clientDao)),
                "/clients");
        return servletContextHandler;
    }
}
